...
<head>
    <meta charset="utf-8" />
    <title>Metronic Admin Theme #4 | User Login 5</title>
    ...
    <div class="row bs-reset">
        ...
        <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
            <div class="login-content">
                <h1>Salon Administrator Login</h1>
                <p> Log in to your account using the form below. </p>
                <form action="javascript:;" class="login-form" method="post">
                    <div class="alert alert-danger display-hide">
                        <button class="close" data-close="alert"></button>
                        <span>Please fill out the fields highlighted in red. </span>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text-right">
                            <div class="forgot-password">
                                ...
                                <a href="javascript:;" id="forget-password" class="forget-password"> Register</a>
                            </div>
                            <button class="btn btn-outline red" type="submit">Sign In</button>
                        </div>
                    </div>
                </form>
                <!-- BEGIN FORGOT PASSWORD FORM -->
                <form class="forget-form" action="javascript:;" method="post">
                    <h3 class="font-blue-steel">Forgot Password ?</h3>
                    <p> Enter your e-mail address below to reset your password. </p>
                    <div class="form-group">
                        <input class="form-control placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Email" name="email" required /> </div>
